...
raster_temp = brick("http://thredds.northwestknowledge.net:8080/thredds/dodsC/agg_met_tmmx_1979_CurrentYear_CONUS.nc", var= var)
...
for(t in 1:length(time_scale)){
  ...
  #integrated_temp[integrated_temp == 0] = NA
  ...
  path_file = paste("/home/zhoylman/drought_indicators/temperature/maps/current_anomaly_",
  ...
  path_file_watershed = paste("/home/zhoylman/drought_indicators/temperature/shp/", sep = "")
