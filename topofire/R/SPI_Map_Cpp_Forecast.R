...
forecast.dir = "/mnt/DataDrive2/data/drought_indices/forecast/precip"
...
#import file names and paths
files.gridmet = list.files(climatology.dir, pattern = ".tif$", full.names = T)
files.forecast = list.files(forecast.dir, pattern = ".tif$", full.names = T)

#merge file vectors
files = c(files.gridmet,files.forecast)
