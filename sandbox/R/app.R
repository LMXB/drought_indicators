...
# library(shiny, lib.loc = "/home/zhoylman/R/x86_64-pc-linux-gnu-library/3.6/")
# #library(foshinyo, lib.loc="~/dev/foo/v1")  
# library(leaflet)
...
#     includeHTML("/home/zhoylman/drought_indicators/spi_app/widgets/m_raster_test.html"),
#     #uiOutput('mymap'),
...
#       #output$mymap = renderUI(includeHTML("/home/zhoylman/drought_indicators/spi_app/widgets/m_huc_widget/index.html"))
#       output$mymap = renderText("/home/zhoylman/drought_indicators/spi_app/widgets/m_huc_widget/index.html")
#     })
# 
...
#       # getPage<-function() {
#       #   return(includeHTML("/home/zhoylman/drought_indicators/spi_app/widgets/m_raster_widget/index.html"))
#       # }
#       # output$mymap<-renderUI({getPage()})
#       #output$mymap =renderUI({includeHTML("/home/zhoylman/drought_indicators/spi_app/widgets/m_raster_test")})
#       output$mymap = renderUI({includeHTML("/home/zhoylman/drought_indicators/spi_app/widgets/m_raster_test.html")})
#       
#     })
# 
# 
...
#   getPage<-function() {
#     return(includeHTML("/home/zhoylman/drought_indicators/spi_app/widgets/m_raster_test.html"))
#   }
