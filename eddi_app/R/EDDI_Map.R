...
for(t in 1:length(time_scale)){
  ...
  if(t > (length(time_scale)-2)){
    if(t == (length(time_scale)-1)){
      layer_name = paste("current_eddi_watershed_water_year", sep = "")
    }
    if(t == (length(time_scale))){
      layer_name = paste("current_eddi_watershed_year_to_date", sep = "")
    }
  }
  ...
  if(t > (length(time_scale)-2)){
    if(t == (length(time_scale)-1)){
      layer_name = paste("current_eddi_county_water_year", sep = "")
    }
    if(t == (length(time_scale))){
      layer_name = paste("current_eddi_county_year_to_date", sep = "")
    }
  }
