...
```{r echo = F}
load("/home/zhoylman/drought_indicators/snotel/widgets/precip_snotel.RData")
precip_map
```
...
```{r echo = F}
load("/home/zhoylman/drought_indicators/snotel/widgets/swe_snotel.RData")
swe_map
```
...
load("/home/zhoylman/drought_indicators/spi_app/widgets/m_raster.RData")
m_raster
...
load("/home/zhoylman/drought_indicators/spi_app/widgets/m_county.RData")
m_county
...
```{r echo=F}
load("/home/zhoylman/drought_indicators/spi_app/widgets/m_huc.RData")
m_huc
```
...
load("/home/zhoylman/drought_indicators/spei_app/widgets/m_raster.RData")
m_raster
...
load("/home/zhoylman/drought_indicators/spei_app/widgets/m_county.RData")
m_county
...
```{r echo=F}
load("/home/zhoylman/drought_indicators/spei_app/widgets/m_huc.RData")
m_huc
```
...
load("/home/zhoylman/drought_indicators/eddi_app/widgets/m_raster.RData")
m_raster
...
load("/home/zhoylman/drought_indicators/eddi_app/widgets/m_county.RData")
m_county
...
```{r echo=F}
load("/home/zhoylman/drought_indicators/eddi_app/widgets/m_huc.RData")
m_huc
```
