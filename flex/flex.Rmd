...
```{r echo=F}
library(shiny)
  shinyAppDir("../spi_app/R/", options = list(height = 1600))
```
...
```{r echo = F}
library(shiny)
shinyAppDir("../spei_app/R/", options = list(height = 1600))
```
...
**EDDI IS NOT SUPPORTED QUITE YET**
...
```{r echo = F}
library(shiny)
shinyAppDir("../shiny-dashboard/R/", options = list(height = 1500))
```