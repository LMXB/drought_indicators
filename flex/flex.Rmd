...
##### Please allow ~20-30 seconds for this webpage to load. This initiation process only happens once.
...
#### **Overview:**
SNOTEL is an automated system of snowpack and related enviormental sensors. SNOTEL is operated by the Natural Resources Conservation Service (NRCS) of the United States Department of Agriculture in the Western United States. Plots in this modual show total snow water equievelant (SWE) and total liquid precipitation (rain + SWE) measured to date compared to historical averages. 

<br>



##### Click on a tab to activate Snotel plot. 
